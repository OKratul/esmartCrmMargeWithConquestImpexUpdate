                            ...
                            <div class="card mb-4">
                                @foreach($invoices as $invoice)
                                    ...
                                    <div class="card-body text-left">
                                        ...
                                        @include('success')
                                        <div class="card p-4">
                                            <form method="POST" action="{{route('user-update-invoice',[$customer_id,$invoice->id])}}" >
                                                {{csrf_field()}}
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                            ...
                                                            @foreach($products as $index=>$product)
                                                                <div class="product-remove-button">
                                                                    <button type="submit" class="btn btn-danger">
                                                                        <a class="text-white" onclick="return confirm('Are you sure you want to delete this Product?')"  href="{{ route('remove-single-product', [$customer_id,$invoice->id,$index]) }}">Delete</a>
                                                                    </button>
                                                                </div>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <select class="form-control" name="unit[]" required="">
                                                                            ...
                                                                            @foreach($unites as $unit)
                                                                                <option {{$unit['unit'] == $product['unit'] ? 'selected' : ''}} value="{{$unit->unit}}" >{{$unit->unit}}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
                                                                    <div class="mb-3">
                                                    ...
                                                    <div class="col-xl-6">
                                                        <div class="card-body text-left">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <select required="" name="logo" id="customer" class="form-select">
                                                                    ...
                                                                    <option selected="" value="Conquest Impex">Conquest Impex</option>
                                                                </select>
                                                            </div>
                                                            <div class="mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <select name="payment_type" id="defaultSelect" class="form-select">
                                                                    <option> </option>
                                                                    @foreach($paymentTypes as $paymentType)
                                                                         <option value="{{$paymentType->payment_type}}" {{$invoice->payment_type == $paymentType->payment_type ? 'selected': ''}}>{{$paymentType->payment_type}}</option>
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input placeholder="Input Allows (3,7.5,10.5) Do Not Use (%) " name="vat_tax" value="{{$invoice->vat_tax}}" type="text" class="form-control phone-mask">
                                                            </div>
                                                            <div class="mb-3">
                                                                ...
                                                                <select name="delivery_term" id="defaultSelect" class="form-select">
                                                                     ...
                                                                     @foreach($deliveryTerms as $deliveryTerm)
                                                                        <option {{$deliveryTerm->delivery_term == $invoice->delivery_term ? 'selected' : ''}} value="{{$deliveryTerm->delivery_term}}">{{$deliveryTerm->delivery_term}} </option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                            <div class="mb-3">
                                                        ...
                                                        <div class="card-body text-left">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="number" value="{{$invoice->delivery_charge}}" name="delivery_charge" class="form-control phone-mask">
                                                            </div>
                                                            <div class="mb-3">
