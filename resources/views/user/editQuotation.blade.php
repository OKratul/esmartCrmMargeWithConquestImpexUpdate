                    ...
                    <div class="customers">
                        <div class="card p-4">
                            @foreach($quotations as $quotation)
                                <form method="POST" action="{{route('user-update-quotation',[$quotation->id])}}" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="card-body text-left" id="productDetailsContainer">
                                            ...
                                            @foreach($products as $index => $product)
                                                <div>
                                                    <a href="{{route('delete-single-product',[$customer_id,$quotation->id,$index])}}" class="btn btn-danger">Remove</a>
                                                </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="card-body text-left">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input value="{{$quotation->phone_number}}" type="number" name="phone_number" class="form-control">
                                            </div>
                                        </div>
                                        <div class="card-body text-left">
                                        ...
                                        <div class="card-body text-left">
                                            <div class="mb-3 ">
                                                ...
                                                <input required class="form-control" name="delivery_date" type="text" value="{{ $quotation->delivery_date }}" id="html5-date-input">
                                            </div>
