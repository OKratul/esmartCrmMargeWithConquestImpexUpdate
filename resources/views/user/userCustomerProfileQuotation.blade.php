                        ...
                        <div class="col-xl-9">
                            ...
                            <div class="text-left">
                                <button class="btn btn-primary m-1">
                                    <a class="text-white" href="{{route('user-view-add-quotation',[$customer_id])}}">Add New<i class='bx bx-plus'></i></a>
                                </button>
                            </div>
                            <div class="card">
                                                ...
                                                @foreach($customer->quotations as $key=>$quotation)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="">
                                                                <div class="mt-1">
                                                                    <a class="text-white btn btn-sm btn-primary" href="{{route('user-view-edite-quotation-from-profile',[$customer_id,$quotation->id])}}">Edit</a>

                                                                    <a class="text-white btn btn-sm btn-primary" href="{{route('view-quotation-pdf',[$customer_id,$quotation->id])}}">View</a>

                                                                    <a class="text-white btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this quotation?')" href="{{route('delete-quotation',[$customer_id,$quotation->id])}}">Delete</a>

                                                                </div>
                                                                <div class="mt-1">
                                                                    <a class="text-white btn btn-sm btn-primary" href="{{route('view-invoice-generator',[$customer_id,$quotation->id])}}">Make Inv..</a>
                                                                    <a class="text-white btn btn-sm btn-primary" href="{{route('sent-quotation-mail',[$customer_id,$quotation->id])}}">Sent Mail</a>
                                                                </div>
                                                                <div class="mt-1">
                                                                   <a class="text-white btn btn-sm btn-primary" href="{{route('generate-pdf-download',[$customer_id,$quotation->id])}}">Download</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
