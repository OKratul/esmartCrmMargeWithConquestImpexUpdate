                        ...
                        <div class="col-xl-9">
                            <div class="card mb-4">
                                    <div class="card-body text-left">
                                        ...
                                        @include('success')
                                        <div class="card p-4">
                                            <form method="POST" action="{{route('generate-new-invoice',[$customer_id])}}">
                                                {{csrf_field()}}
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                    ...
                                                    <div class="col-xl-6">
                                                        ...
                                                        <div class="card-body text-left">
                                                            ...
                                                            <input required id="user-value" class="form-control phone-mask" type="text" name="created_by">
                                                        </div>
