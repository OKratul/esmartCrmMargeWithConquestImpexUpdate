...
//        dd($quotations);
        ...
        return view('adminAllQuotation',
            compact('quotations','totalQuotation','unites','users',
                'totalQuotationValue',
                'totalSentValue',
                ...
                'quotationNotSents',
                'quotationSents'
                ,'statuses','querySources','deliveryTerms','paymentTypes','warranties','pageTitle'));
    }
    ...
    public function showEditQuotation($quotation_id){
        ...
        return view('editQuotation',compact('quotations','users','customer_id',
...
//        dd(\request()->all());
        ...
        return redirect('admin/all-quotation')->with('success','Quotation Updated Successfully');
